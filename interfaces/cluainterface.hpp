...
public:
	...
	/*39*/	virtual bool IsType(int, void*) = 0;
	...
	/*48*/	virtual void* PushAngle(Angle const&) = 0;
	...
	/*92*/	virtual void* RunString(const char* filename, const char* path, const char* stringToRun, bool run, bool printErrors) = 0;
	...
	/*111*/	virtual void* RunStringEx(const char* filename, const char* path, const char* stringToRun, bool run, bool printErrors, bool dontPushErrors, bool noReturns) = 0;
	...
	/*115*/	virtual void* MsgColour(int const&, char const*, ...) = 0;
	...
	/*126*/	virtual void* CreateConVar(char const* name, char const* description, char const* value, int) = 0;

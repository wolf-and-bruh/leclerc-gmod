...
public:
	...
	/*14*/	virtual void* GetSoundSpatialization(void) = 0;
	...
	/*20*/	virtual void* ModifyFireBulletsDamage(void*) = 0;
	...
	/*25*/	virtual void* DispatchTraceAttack(void* const&, Vector const&, trace_t*, void*) = 0;
	/*26*/	virtual void* TraceAttack(void* const&, Vector const&, trace_t*, void*) = 0;
	/*27*/	virtual void* DoImpactEffect(trace_t&, int) = 0;
	/*28*/	virtual void* MakeTracer(Vector const&, trace_t const&, int) = 0;
	/*29*/	virtual void* GetTracerAttachment(void) = 0;
	/*30*/	virtual void* BloodColor(void) = 0;
	...
	/*66*/	virtual void* TestCollision(Ray_t const&, unsigned int, trace_t&) = 0;
	/*67*/	virtual void* TestHitboxes(Ray_t const&, unsigned int, trace_t&) = 0;
	...
	/*117*/	virtual void* GetAttachmentVelocity(int, Vector&, void*&) = 0;
	...
	/*132*/	virtual void* GetAimEntOrigin(void*, Vector*, Angle*) = 0;
	...
	/*162*/	virtual void* AddDecal(Vector const&, Vector const&, Vector const&, int, int, bool, trace_t&, int) = 0;
	...
	/*169*/	virtual void* DecalTrace(trace_t*, char const*) = 0;
	/*170*/	virtual void* ImpactTrace(trace_t*, int, char const*) = 0;
	/*171*/	virtual bool ShouldPredict(void) = 0;
	/*172*/	virtual void* Think(void) = 0;
	/*173*/	virtual void* CanBePoweredUp(void) = 0;
	/*174*/	virtual void* AttemptToPowerup(int, float, float, C_BasePlayer*, void*) = 0;
	/*175*/	virtual bool IsCurrentlyTouching(void)const = 0;
	/*176*/	virtual void* StartTouch(C_BasePlayer*) = 0;
	/*177*/	virtual void* Touch(C_BasePlayer*) = 0;
	/*178*/	virtual void* EndTouch(C_BasePlayer*) = 0;
	...
	/*211*/	virtual void* SetShadowUseOtherEntity(C_BasePlayer*) = 0;
	/*212*/	virtual void* AddRagdollToFadeQueue(void) = 0;
	/*213*/	virtual bool IsDeflectable(void) = 0;
	/*214*/	virtual void* GetStudioBody(void) = 0;
	/*215*/	virtual void* PerformCustomPhysics(Vector*, Vector*, Angle*, Angle*) = 0;
	...
	/*235*/	virtual void SetEntity(char const*, C_BasePlayer*) = 0;
	...
	/*267*/	virtual void* BuildTransformations(void*, Vector*, void*, Matrix3x4 const&, int, void*, Vector const*) = 0;
	...
	/*276*/	virtual void* FireEvent(Vector const&, Angle const&, int, char const*) = 0;
	/*277*/	virtual void* FireObsoleteEvent(Vector const&, Angle const&, int, char const*) = 0;
	...
	/*281*/	virtual void* StandardBlendingRules(void*, Vector*, void*, float, int) = 0;
	/*282*/	virtual void* AccumulateLayers(void*, Vector*, void*, float) = 0;
	/*283*/	virtual void* ChildLayerBlend(Vector*, void*, float, int) = 0;
	/*284*/	virtual void* AttachEntityToBone(void*, int, Vector, Angle) = 0;
	...
	/*290*/	virtual void* RetrieveRagdollInfo(Vector*, void*) = 0;
	...
	/*333*/	virtual void* DefaultTouch(C_BasePlayer*) = 0;
	/*334*/	virtual void* GiveTo(C_BasePlayer*) = 0;
	...
	/*372*/	virtual void* CreateMove(float, CUserCmd*, Angle const&) = 0;
	...
	/*396*/	virtual void WeaponSound(void*, float) = 0;
	/*397*/	virtual void StopWeaponSound(void*) = 0;
	...
	/*408*/	virtual void* AddViewmodelBob(void*, Vector&, Angle&) = 0;
	...
	/*456*/	virtual void* OnFireEvent(void*, Vector const&, Angle const&, int, char const*) = 0;
	...
	/*469*/	virtual void* KeyInput(int, void*, char const*) = 0;
	...
	/*487*/	virtual void* EquipAmmo(C_BasePlayer*) = 0;
	...
	int PrimaryAmmoCount() {
		return *reinterpret_cast<int*>((uintptr_t)this + 0x1C48);
	}
	int SecondaryAmmoCount() {
		return *reinterpret_cast<int*>((uintptr_t)this + 0x1C4C);
	}
	float NextPrimaryAttack() {
		return *reinterpret_cast<float*>((uintptr_t)this + 0x1BFC);
	}
	float NextSecondaryAttack() {
		return *reinterpret_cast<float*>((uintptr_t)this + 0x1C00);
	}
};